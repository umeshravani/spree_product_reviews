module Spree
  module PageSections
    ...
    class AddAReview < (defined?(Spree::PageSection) ? Spree::PageSection : Object)
      
      # Only execute Spree-specific logic if the parent is actually a PageSection
      if defined?(Spree::PageSection)
